import { r as BetterAuthOptions } from "../index-DWd5qAaC.mjs";
...
declare const sveltekitCookies: (getRequestEvent: () => RequestEvent<any, any>) => {
  ...
  hooks: {
    after: {
      matcher(): true;
      handler: (inputContext: better_call131.MiddlewareInputContext<better_call131.MiddlewareOptions>) => Promise<void>;
    }[];
  };
};
//#endregion
