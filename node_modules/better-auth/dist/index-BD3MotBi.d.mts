import { m as InferUser, p as InferSession } from "./index-DWd5qAaC.mjs";
...
declare const customSession: <Returns extends Record<string, any>, O extends BetterAuthOptions = BetterAuthOptions>(fn: (session: {
  ...
  hooks: {
    after: {
      ...
      handler: (inputContext: better_call192.MiddlewareInputContext<better_call192.MiddlewareOptions>) => Promise<Awaited<Returns>[] | undefined>;
    }[];
  };
  endpoints: {
    getSession: better_call192.StrictEndpoint<"/get-session", {
      method: "GET";
