import { Bt as index_d_exports, _ as User, g as Session } from "./index-DWd5qAaC.mjs";
...
import * as better_call175 from "better-call";
...
declare const jwt: (options?: JwtOptions | undefined) => {
  ...
  endpoints: {
    getJwks: better_call175.StrictEndpoint<string, {
      method: "GET";
      metadata: {
        openapi: {
          operationId: string;
    ...
    getToken: better_call175.StrictEndpoint<"/token", {
      method: "GET";
      requireHeaders: true;
      use: ((inputContext: better_call175.MiddlewareInputContext<better_call175.MiddlewareOptions>) => Promise<{
        session: {
    ...
    signJWT: better_call175.StrictEndpoint<"/sign-jwt", {
      method: "POST";
      metadata: {
        SERVER_ONLY: true;
        $Infer: {
    ...
    verifyJWT: better_call175.StrictEndpoint<"/verify-jwt", {
      method: "POST";
      metadata: {
        SERVER_ONLY: true;
        $Infer: {
  ...
  hooks: {
    after: {
      ...
      handler: (inputContext: better_call175.MiddlewareInputContext<better_call175.MiddlewareOptions>) => Promise<void>;
    }[];
  };
  schema: {
    jwks: {
