import { _ as User } from "./index-DWd5qAaC.mjs";
import { t as Awaitable } from "./helper-BTuR6T4N.mjs";
import { t as InferOptionSchema } from "./plugins-B2LAIIX7.mjs";
import * as _better_auth_core12 from "@better-auth/core";
import { GenericEndpointContext } from "@better-auth/core";
import * as better_call220 from "better-call";
...
declare const phoneNumber: (options?: PhoneNumberOptions | undefined) => {
  ...
  hooks: {
    before: {
      ...
      handler: (inputContext: better_call220.MiddlewareInputContext<better_call220.MiddlewareOptions>) => Promise<never>;
    }[];
  };
  endpoints: {
    /**
     ...
     */
    signInPhoneNumber: better_call220.StrictEndpoint<"/sign-in/phone-number", {
      method: "POST";
      body: z.ZodObject<{
     ...
     */
    sendPhoneNumberOTP: better_call220.StrictEndpoint<"/phone-number/send-otp", {
      method: "POST";
      body: z.ZodObject<{
        phoneNumber: z.ZodString;
      }, z.core.$strip>;
     ...
     */
    verifyPhoneNumber: better_call220.StrictEndpoint<"/phone-number/verify", {
      method: "POST";
      body: z.ZodObject<{
        phoneNumber: z.ZodString;
        code: z.ZodString;
    ...
    requestPasswordResetPhoneNumber: better_call220.StrictEndpoint<"/phone-number/request-password-reset", {
      method: "POST";
      body: z.ZodObject<{
        phoneNumber: z.ZodString;
      }, z.core.$strip>;
    ...
    resetPasswordPhoneNumber: better_call220.StrictEndpoint<"/phone-number/reset-password", {
      method: "POST";
      body: z.ZodObject<{
        otp: z.ZodString;
        phoneNumber: z.ZodString;
