...
declare const oAuthProxy: (opts?: OAuthProxyOptions | undefined) => {
  ...
  endpoints: {
    oAuthProxy: better_call168.StrictEndpoint<"/oauth-proxy-callback", {
      method: "GET";
      operationId: string;
      query: z.ZodObject<{
      ...
      use: ((inputContext: better_call168.MiddlewareInputContext<better_call168.MiddlewareOptions>) => Promise<void>)[];
      metadata: {
        openapi: {
          operationId: string;
          description: string;
  ...
  hooks: {
    before: {
      ...
      handler: (inputContext: better_call168.MiddlewareInputContext<better_call168.MiddlewareOptions>) => Promise<void>;
    }[];
    after: {
      matcher(context: _better_auth_core4.HookEndpointContext): boolean;
      handler: (inputContext: better_call168.MiddlewareInputContext<better_call168.MiddlewareOptions>) => Promise<void>;
