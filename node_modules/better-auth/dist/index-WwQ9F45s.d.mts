import { o as LiteralString } from "./helper-BTuR6T4N.mjs";
...
import * as better_call151 from "better-call";
...
declare const openAPI: <O extends OpenAPIOptions>(options?: O | undefined) => {
  id: "open-api";
  endpoints: {
    generateOpenAPISchema: better_call151.StrictEndpoint<"/open-api/generate-schema", {
      method: "GET";
    } & {
      use: any[];
    }, {
    ...
    openAPIReference: better_call151.StrictEndpoint<"/reference", {
      method: "GET";
      metadata: {
        isAction: false;
      };
