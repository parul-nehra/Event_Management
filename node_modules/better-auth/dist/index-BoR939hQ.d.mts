...
import * as _better_auth_core_db19 from "@better-auth/core/db";
import * as better_call227 from "better-call";
  ...
  user: {
    fields: {
      username: {
        ...
        returned: true;
        transform: {
          input(value: _better_auth_core_db19.DBPrimitive): string | number | boolean | Date | unknown[] | Record<string, unknown> | null | undefined;
        };
      };
      displayUsername: {
        type: "string";
...
declare const username: (options?: UsernameOptions | undefined) => {
      ...
      databaseHooks: {
        user: {
          create: {
            ...
            } & Record<string, unknown>, context: _better_auth_core16.GenericEndpointContext | undefined): Promise<{
              data: {
  ...
  endpoints: {
    signInUsername: better_call227.StrictEndpoint<"/sign-in/username", {
      method: "POST";
      body: z.ZodObject<{
    ...
    isUsernameAvailable: better_call227.StrictEndpoint<"/is-username-available", {
      method: "POST";
      body: z.ZodObject<{
        username: z.ZodString;
      }, z.core.$strip>;
  ...
  hooks: {
    before: {
      ...
      handler: (inputContext: better_call227.MiddlewareInputContext<better_call227.MiddlewareOptions>) => Promise<void>;
    }[];
  };
  $ERROR_CODES: {
    readonly INVALID_USERNAME_OR_PASSWORD: "Invalid username or password";
