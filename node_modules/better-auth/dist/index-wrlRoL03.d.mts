import { _ as User, g as Session } from "./index-DWd5qAaC.mjs";
...
import * as better_call237 from "better-call";
...
declare const anonymous: (options?: AnonymousOptions | undefined) => {
  id: "anonymous";
  endpoints: {
    signInAnonymous: better_call237.StrictEndpoint<"/sign-in/anonymous", {
      method: "POST";
      metadata: {
        openapi: {
          description: string;
  ...
  hooks: {
    after: {
      matcher(ctx: _better_auth_core20.HookEndpointContext): boolean;
      handler: (inputContext: better_call237.MiddlewareInputContext<better_call237.MiddlewareOptions>) => Promise<void>;
    }[];
  };
  schema: {
    user: {
